...
node() {
  ...
  withCredentials([
        ...
        stage("Terraform to Provision the 3 App VMs + Consul Server VM in Azure") {
          ...
          sh '''
              cp -r /var/jenkins_home/workspace/Webblog_App@script/Terraform/ProvisionAppVMs/end-to-end-infra-app-deployment/* /var/jenkins_home/workspace/Webblog_App@script/Terraform/ProvisionAppVMs
